...
var sql = {
	...
	prepareCriterion: function(collectionName, value, key, parentKey) {
		console.log('prepareCriterion collectionName, value, key, parentKey',collectionName, value, key, parentKey);

		if (validSubAttrCriteria(value)) {
			console.log('validSubAttrCriteria');
	...
	predicate: function(collectionName, criterion, key, parentKey) {
		console.log('predicate collectionName, criterion, key, parentKey',collectionName, criterion, key, parentKey);
		var queryPart = '';
	...
	build: function(collectionName, collection, fn, separator, keyOverride, parentKey) {
		...
		console.log('build collectionName, collection, fn, separator, keyOverride, parentKey',collectionName, collection, fn, separator, keyOverride, parentKey);

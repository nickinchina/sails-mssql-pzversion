...
module.exports = (function () {
    ...
    var adapter = {
        ...
        find: function(collectionName, options, cb) {
            ...
            var arch = undefined;
            if (collectionName=="pz_promotion"){
            ...
            if (arch) {
              ...
              statement = statement + ' UNION ALL ' +  sql.selectQuery("dw.pz_promotion", options);
              statement = statement.replace(/\*/g,'code, name, inactive, rules, actions, distondist, rebate, rebateentityid,manualexecution, images, stores, storeids, transform, props, id, createdAt, updatedAt, ordinal, description,pubstatus, rebatetaxable, canceltime')
